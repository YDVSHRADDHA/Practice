        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 lg:px-16">
          <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            ...
            <p className="mt-4 text-lg  mb-6 text-gray-600">
              ...
              exhibits. We believe that an organisation also has similar traits,
              and culture is an expression of that."{" "}
            </p>

            <a
              href="/services"
              className="inline-block bg-red-700 text-white py-3 px-6 rounded-lg text-lg"
            >
              SRS Services
            </a>
          </div>
 ...
 */}
      ...
      <section
        id="about"
        className=" bg-cover bg-center h-96 max-w-screen-2xl mx-auto px-4 py-16 lg:py-24 relative bg-gray-50"
        style={{
          backgroundImage:
            "url(https://i.pinimg.com/564x/b4/31/80/b43180abbfc0636d7fecf84768ec9ec6.jpg)",
        }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col items-center justify-center text-center text-white py-12 px-6">
          ...
          <h2 className="text-5xl mt-2">
            Embracing the Future with Passion and Purpose
          </h2>
          <p className="mt-4 text-lg">
            We are the change-makers, driven by passion and purpose. Together,
            let’s build a future where innovation and growth know no bounds. Our
            generation, our future! We believe in fostering a love for learning
            and encouraging students to become independent thinkers.
          </p>
        </div>
      </section>
        ...
        <div className="  mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl   font-extrabold text-gray-900 ">
              The future of the <span className="text-red-700">Youth!</span>
            </h1>

            <p className="mt-4 text-black">
              We are the best, driven by results and excellence. Together, let's
              set new benchmarks and create a future where our hard work and
              dedication make us stand out. Our goals, our triumphs!
            </p>
            <a
              href="#"
              className="bg-red-500 text-white py-3 px-6 text-lg rounded cursor-pointer hover:bg-red-700 inline-block"
            >
              Read More
            </a>
          </div>
          <img
            src="https://i.pinimg.com/564x/c6/8c/9b/c68c9be1d2bb7a540c68652ca8fa594d.jpg"
            alt="Showcase"
            className="w-full"
          />
        </div>
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-3">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-700">
              I had a great experience at Vedantu. All my concepts were clear
              and I felt confident while appearing for the board exams.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-700">
              The LIVE interactive classes with visual explanations helped me
              learn and retain all the topics better.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center mb-4">
          ...
          <div className="flex flex-1">
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <img
                  className="object-cover h-full"
                  src="https://i.pinimg.com/564x/47/36/2e/47362e745f4f63577c221c3e1b4d4a9a.jpg"
                  alt=""
                />
              </div>
              <div>
    ...
    <h2 className="text-4xl font-extrabold text-gray-900">
      ...
      <section className="my-8 max-w-screen-2xl mx-auto px-4 py-16 lg:py-24 relative bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <a
            href="https://i.pinimg.com/564x/a9/c3/26/a9c326fc17a1acc30808acd5d257bedf.jpg"
            className="col-span-2 row-span-2"
          >
            <img
              src="https://i.pinimg.com/564x/a9/c3/26/a9c326fc17a1acc30808acd5d257bedf.jpg"
              alt="Gallery 1"
          ...
          >
            <img
              src="https://i.pinimg.com/564x/a7/83/da/a783da3eac3e145f3d6f58c6395520df.jpg"
              alt="Gallery 2"
              className="w-full h-full object-cover"
            />
          </a>
          <a href="https://i.ibb.co/xSnHP7g/gal43884.jpg">
            <img
              src="https://i.pinimg.com/236x/6a/42/e7/6a42e7884a092a4cde21b84e10b1783c.jpg"
              alt="Gallery 3"
              className="w-full h-full object-cover"
            />
          </a>
          <a href="https://i.ibb.co/QN6Bnrb/gal4958.jpg">
            <img
              src="https://i.pinimg.com/564x/6e/fe/a8/6efea8684db95f73c7739122668dcded.jpg"
              alt="Gallery 4"
              className="w-full h-full object-cover"
            />
          </a>
          ...
          <a href="https://i.ibb.co/S6FVFNt/gal74744.jpg">
            <img
              src="https://i.pinimg.com/564x/38/3d/95/383d957de344289164427caf94db8cc4.jpg"
              alt="Gallery 6"
              className="w-full h-full object-cover"
            />
          </a>
      ...
      <div className="text-center bg-cover bg-center h-auto max-w-screen-2xl mx-auto px-4 py-16 lg:py-24 relative bg-gray-50 mb-2 gap-5">
        ...
        <p className="text-gray-500 text-5xl py-12">
          {" "}
          " Together, let's drive change and shape a future full of innovation
          and excellence. Our passion, our impact! 🚀✨"
        </p>
      </div>
